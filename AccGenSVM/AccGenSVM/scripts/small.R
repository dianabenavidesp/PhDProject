...
existsFile<-function(wd, dataRep, percentData, positive, negative)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percent/data/data",dataRep,"/sampletransfer",positive,"_",negative,".csv",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percent/data/data",dataRep,"/sampletransfer",positive,"_",negative,".csv",sep="")) > 0)
  {
    return(1)
  }
...
smallsize <- function(positive, percent, size, rep)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
    ...
    for(negative in 1:256)
    {
      ...
      if(negative!=positive && existsFile(getwd(), rep, percent, positive, negative))
      {
        fileName<-paste(getwd(),"/positives/",positive,"/",percent*100,"percent/data/data",rep,"/sampletransfer",positive,"_",negative,sep="")
        data<-read.csv(paste(fileName,".csv",sep=""), stringsAsFactors =FALSE, header=FALSE)
        matrix<-matrix(0,as.integer(nrow(data)*size), 1000)
        classes<-matrix(0,as.integer(nrow(data)*size), 1)
        
        sampleRows <- sample(1:nrow(data), nrow(data)*size)
        ...
        for(i in 1:nrow(data))
        {
            ...
            if(i %in% sampleRows)
            {
              ...
              {
                third<-as.numeric(trimws(unlist(secondSplit[[k]])[1]))
                matrix[j,k-1]<-third
              }
              
              classes[j,1]<-as.numeric(trimws(unlist(secondSplit[[1]])[1]))
              
              j<-j+1
            }
        }
        
        data2<-as.data.frame(matrix)
        data2<-cbind(data2, classes)
        data2<-getfinaldataCaltech(data2)
        
        write.table(data2,paste(getwd(),"/positives/",positive,"/",percent*100,"percentextension/data/data",rep,"/sampletransfer",positive,"_",negative,"_size",size*100,".csv", sep=""),row.names=FALSE, quote=FALSE, col.names=FALSE, sep=",")
      }
    },error=function(e){})
    }
}
...
smallsize(251,0.10, 0.50, 1)
smallsize(251,0.10,0.50, 2)
smallsize(251,0.10,0.50, 3)
smallsize(251,0.10,0.50, 4)
smallsize(251,0.10,0.50, 5)
smallsize(251,0.10,0.50, 6)
smallsize(251,0.10,0.50, 7)
smallsize(251,0.10,0.50, 8)
smallsize(251,0.10,0.50, 9)
smallsize(251,0.10,0.50, 10)

smallsize(251,0.10,0.50, 11)
smallsize(251,0.10,0.50, 12)
smallsize(251,0.10,0.50, 13)
smallsize(251,0.10,0.50, 14)
smallsize(251,0.10,0.50, 15)
smallsize(251,0.10,0.50, 16)
smallsize(251,0.10,0.50, 17)
smallsize(251,0.10,0.50, 18)
smallsize(251,0.10,0.50, 19)
smallsize(251,0.10,0.50, 20)

smallsize(251,0.10,0.50, 21)
smallsize(251,0.10,0.50, 22)
smallsize(251,0.10,0.50, 23)
smallsize(251,0.10,0.50, 24)
smallsize(251,0.10,0.50, 25)
smallsize(251,0.10,0.50, 26)
smallsize(251,0.10,0.50, 27)
smallsize(251,0.10,0.50, 28)
smallsize(251,0.10,0.50, 29)
smallsize(251,0.10,0.50, 30)

fixFilesSmall<-function(num, percent, size)
{
  ...
  for(k in 11:30)
  {
    ...
    for(i in 1:256)
    {
      if(i!=num && file.exists(paste(getwd(),"/",num,"/",percent*100,"percentextension/data/data",iter,"/sampletransfer",num,"_",i,"_size",size*100,".csv",sep="")))
      {
        filenames[j]<-paste(num,"/",percent*100,"percentextension/data/data",iter,"/sampletransfer",num,"_",i,"_size",size*100,".csv",sep="")
        j<-j+1
      }
...
existsFileTransfer<-function(wd, dataRep, percentData, positive, negative, size)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/data/data",dataRep,"/sampletransfer",positive,"_",negative,"_size",size*100,".csv.scale",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/data/data",dataRep,"/sampletransfer",positive,"_",negative,"_size",size*100,".csv.scale",sep="")) > 1)
  {
    return(1)
  }
...
transferaccgen<-function(class, relatedAll, percentData, percentHyp, dataRep, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(neg in 1:length(negatives))
  {
    ...
    if(!negative %in% relatedAll && numModels <= maxModels && class!=negative && existsFileTransfer(getwd(), dataRep, percentData, positive, negative, size) == 1)
    {
      targetData <- paste("-f ", getwd(),"/positives/",class,"/",percentData*100,"percentextension/data/data",dataRep, "/sampletransfer",positive,"_",negative,"_size",size*100,".csv.scale ", sep="")
      ...
      outputModel<-paste("-y ", getwd(),"/positives/",class,"/",percentData*100,"percentextension/transfer/data",dataRep, "/sampletransfer",positive,"_",negative,"ACCGEN_","_size",size*100,percentHyp*100,"hyp.csv.model ", sep="")
      
      outputInfo<-paste("-a ", getwd(),"/positives/",class,"/",percentData*100,"percentextension/transfer/data",dataRep, "/sampletransfer",positive,"_",negative,"ACCGEN_","_size",size*100,percentHyp*100,"hyp.out", sep="")
  ...
  write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/accgensmall-pos",class,"-",percentData*100,"data-",percentHyp*100,"hyp.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
}

transferaccgen(251,c(243, 248),0.1,1,1,0.5)
transferaccgen(251,c(243, 248),0.1,1,2,0.5)
transferaccgen(251,c(243, 248),0.1,1,3,0.5)
transferaccgen(251,c(243, 248),0.1,1,4,0.5)
transferaccgen(251,c(243, 248),0.1,1,5,0.5)
transferaccgen(251,c(243, 248),0.1,1,6,0.5)
transferaccgen(251,c(243, 248),0.1,1,7,0.5)
transferaccgen(251,c(243, 248),0.1,1,8,0.5)
transferaccgen(251,c(243, 248),0.1,1,9,0.5)
transferaccgen(251,c(243, 248),0.1,1,10,0.5)
transferaccgen(251,c(243, 248),0.1,1,11,0.5)
transferaccgen(251,c(243, 248),0.1,1,12,0.5)
transferaccgen(251,c(243, 248),0.1,1,13,0.5)
transferaccgen(251,c(243, 248),0.1,1,14,0.5)
transferaccgen(251,c(243, 248),0.1,1,15,0.5)
transferaccgen(251,c(243, 248),0.1,1,16,0.5)
transferaccgen(251,c(243, 248),0.1,1,17,0.5)
transferaccgen(251,c(243, 248),0.1,1,18,0.5)
transferaccgen(251,c(243, 248),0.1,1,19,0.5)
transferaccgen(251,c(243, 248),0.1,1,20,0.5)
transferaccgen(251,c(243, 248),0.1,1,21,0.5)
transferaccgen(251,c(243, 248),0.1,1,22,0.5)
transferaccgen(251,c(243, 248),0.1,1,23,0.5)
transferaccgen(251,c(243, 248),0.1,1,24,0.5)
transferaccgen(251,c(243, 248),0.1,1,25,0.5)
transferaccgen(251,c(243, 248),0.1,1,26,0.5)
transferaccgen(251,c(243, 248),0.1,1,27,0.5)
transferaccgen(251,c(243, 248),0.1,1,28,0.5)
transferaccgen(251,c(243, 248),0.1,1,29,0.5)
transferaccgen(251,c(243, 248),0.1,1,30,0.5)

existsModelTransfer<-function(wd, dataRep, percentData, percentHyp, positive, negative, size)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN__size",size*100,percentHyp*100,"hyp.csv.model",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN__size",size*100,percentHyp*100,"hyp.csv.model",sep="")) > 1)
  {
    return(1)
  }
...
traintransfer<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative, size)==1)
      {
        instructions1<-paste(general, getwd(),"/positives/",class,"/",percentData*100,"percentextension/data/data",dataRep,"/sampletransfer",class,"_",negative,"_size",size*100,".csv.scale ", sep="")        
        instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/notransfer/data",dataRep,"/sampletransfer",class,"_",negative,"_size",size*100,percentHyp*100,percentHyp*100,"hyp.csv.model ", sep="")
        instructions3<-paste(">> ", getwd(),"/positives/",class,"/",percentData*100,"percentextension/notransfer/data",dataRep,"/sampletransfer",class,"_",negative,"_size",size*100,percentHyp*100,percentHyp*100,"hyp.out", sep="")
        
        instructions<-paste(instructions1, instructions2, instructions3, sep="")
        
        write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/notransfersmall-pos",class,"-",percentData*100,"data.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

traintransfer(251, 0.10, 0.10, 0.5)
traintransfer(251, 0.10, 0.25, 0.5)
traintransfer(251, 0.10, 0.50, 0.5)
traintransfer(251, 0.10, 1, 0.5)


existsModelTransfer<-function(wd, dataRep, percentData, percentHyp, positive, negative, size)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_","_size",size*100,percentHyp*100,"hyp.csv.model",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_","_size",size*100,percentHyp*100,"hyp.csv.model",sep="")) > 0)
  {
    return(1)
  }
...
predictaccgen<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
    ...
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative, size)==1)
      {
        for(j in 1:256)
        {
          ...
          if(existsFilePredict(getwd(),dataRep,(percentData+0.2),class,negative2)==1 && existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative2, size)==1)
          {
            instructions1<-paste(general, getwd(),"/positives/",class,"/",(percentData+0.2)*100,"percent/data/data",dataRep,"/sampletest",class,"_",negative2,".csv.scale ", sep="")        
            instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/transfer/data",dataRep,"/sampletransfer",class,"_",negative2,"ACCGEN_","_size",size*100,percentHyp*100,"hyp.csv.model ", sep="")
            instructions3<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative2,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.out ", sep="")
            instructions4<-paste(">> ",getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative2,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt", sep="")
            
            instructions<-paste(instructions1, instructions2, instructions3, instructions4,sep="")
            
            write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/testaccgensmall-pos",class,"-",percentData*100,"data-",percentHyp*100,"hyp.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
          }
        }
      }
    }
...
predictnotransfer<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
    ...
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative, size)==1)
      {
        for(j in 1:256)
        {
          ...
          {
            instructions1<-paste(general, getwd(),"/positives/",class,"/",(percentData+0.2)*100,"percent/data/data",dataRep,"/sampletest",class,"_",negative2,".csv.scale ", sep="")        
            instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/notransfer/data",dataRep,"/sampletransfer",class,"_",negative2,"_size",size*100,percentHyp*100,percentHyp*100,"hyp.csv.model ", sep="")
            instructions3<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative2,"usingnotransfer_","_size",size*100,percentHyp*100,".out ", sep="")
            instructions4<-paste(">> ",getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative2,"usingnotransfer_","_size",size*100,percentHyp*100,".txt", sep="")
...
predictaccgen(251, 0.10, 0.10, 0.5)
predictaccgen(251, 0.10, 0.25, 0.5)
predictaccgen(251, 0.10, 0.50, 0.5)
predictaccgen(251, 0.10, 1, 0.5)

predictnotransfer(251, 0.10, 0.10, 0.5)
predictnotransfer(251, 0.10, 0.25, 0.5)
predictnotransfer(251, 0.10, 0.50, 0.5)
predictnotransfer(251, 0.10, 1, 0.5)

#######

existsFileResultsAccGen<-function(wd, positive, negative, percentData, percentHyp, dataRep, size)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",positive,"_",negative,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",positive,"_",negative,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt",sep="")) > 0)
  {
    return(1)
  }
...
existsFileResultsNoTransfer<-function(wd, positive, negative, percentData, percentHyp, dataRep, size)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",positive,"_",negative,"usingnotransfer_","_size",size*100,percentHyp*100,".txt",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",positive,"_",negative,"usingnotransfer_","_size",size*100,percentHyp*100,".txt",sep="")) > 0)
  {
    return(1)
  }
...
resultsaccgen<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsAccGen(getwd(), class, negative, percentData, percentHyp, dataRep, size) ==1)
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt",sep=""))
        result<-result$V3
        result<-as.character(strsplit(as.character(result[1]), split="%")[1])
        result<-as.double(result)
        
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsaccgen_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsaccgenpositive<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt",sep=""))
        result<-as.numeric(gsub("%","", result$V3[result$V1 == "AccuracyPositive"][1]))

        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsaccgenpositive_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsaccgennegative<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative,"usingACCGEN_","_size",size*100,percentHyp*100,"hyp.txt",sep=""))
        result<-as.numeric(gsub("%","", result$V3[result$V1 == "AccuracyNegative"][1]))
        
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsaccgennegative_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsnotransfer<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsNoTransfer(getwd(), class, negative, percentData, percentHyp, dataRep, size) ==1)
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentextension/test/data",dataRep,"/sampletest",class,"_",negative,"usingnotransfer_","_size",size*100,percentHyp*100,".txt",sep=""))
        result<-result$V3
        result<-as.character(strsplit(as.character(result[1]), split="%")[1])
        result<-as.double(result)
        
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsnotransfer_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsnotransferpositive<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsNoTransfer(getwd(), class, negative, percentData, percentHyp, dataRep, size) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsnotransferpositive_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsnotransfernegative<-function(class, percentData, percentHyp, size)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsNoTransfer(getwd(), class, negative, percentData, percentHyp, dataRep, size) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentextension/resultsnotransfernegative_","_size",size*100,percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}
