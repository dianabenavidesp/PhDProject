...
transferaccgen<-function(class, relatedAll, percentData, percentHyp, dataRep)
{
  ...
  positive<-class
  #for caltech256, 251
  unrelatedbalanced<-c(145, 11, 105, 126, 8, 12, 90, 159, 147, 92)
  ...
  for(neg in 1:length(unrelatedbalanced))
  {
    negative<-unrelatedbalanced[neg]
    
    if(!negative %in% relatedAll && class!=negative && existsFileTransfer(getwd(), dataRep, percentData, positive, negative) == 1)
    {
      ...
      outputModel<-paste("-y ", getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep, "/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.csv.model ", sep="")
      
      outputInfo<-paste("-a ", getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep, "/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.out", sep="")
  ...
  write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/accgenunrelatedbalanced-pos",class,"-",percentData*100,"data-",percentHyp*100,"hyp.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
}

transferaccgen(251,c(243, 248),0.1,0.10,1)
transferaccgen(251,c(243, 248),0.1,0.10,2)
transferaccgen(251,c(243, 248),0.1,0.10,3)
transferaccgen(251,c(243, 248),0.1,0.10,4)
transferaccgen(251,c(243, 248),0.1,0.10,5)
transferaccgen(251,c(243, 248),0.1,0.10,6)
transferaccgen(251,c(243, 248),0.1,0.10,7)
transferaccgen(251,c(243, 248),0.1,0.10,8)
transferaccgen(251,c(243, 248),0.1,0.10,9)
transferaccgen(251,c(243, 248),0.1,0.10,10)
transferaccgen(251,c(243, 248),0.1,0.10,11)
transferaccgen(251,c(243, 248),0.1,0.10,12)
transferaccgen(251,c(243, 248),0.1,0.10,13)
transferaccgen(251,c(243, 248),0.1,0.10,14)
transferaccgen(251,c(243, 248),0.1,0.10,15)
transferaccgen(251,c(243, 248),0.1,0.10,16)
transferaccgen(251,c(243, 248),0.1,0.10,17)
transferaccgen(251,c(243, 248),0.1,0.10,18)
transferaccgen(251,c(243, 248),0.1,0.10,19)
transferaccgen(251,c(243, 248),0.1,0.10,20)
transferaccgen(251,c(243, 248),0.1,0.10,21)
transferaccgen(251,c(243, 248),0.1,0.10,22)
transferaccgen(251,c(243, 248),0.1,0.10,23)
transferaccgen(251,c(243, 248),0.1,0.10,24)
transferaccgen(251,c(243, 248),0.1,0.10,25)
transferaccgen(251,c(243, 248),0.1,0.10,26)
transferaccgen(251,c(243, 248),0.1,0.10,27)
transferaccgen(251,c(243, 248),0.1,0.10,28)
transferaccgen(251,c(243, 248),0.1,0.10,29)
transferaccgen(251,c(243, 248),0.1,0.10,30)

existsModelTransfer<-function(wd, dataRep, percentData, percentHyp, positive, negative)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.csv.model",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.csv.model",sep="")) > 1)
  {
    return(1)
  }
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative)==1)
      {
        ...
        instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/notransfer/data",dataRep,"/sampletransfer",class,"_",negative,"_",percentHyp*100,"hyp.csv.model ", sep="")
        instructions3<-paste(">> ", getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/notransfer/data",dataRep,"/sampletransfer",class,"_",negative,"_",percentHyp*100,"hyp.out", sep="")
        
        instructions<-paste(instructions1, instructions2, instructions3, sep="")
        
        write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/notransferbalancedunrelated-pos",class,"-",percentData*100,"data.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

traintransfer(251, 0.10, 0.10)
traintransfer(251, 0.10, 0.25)
traintransfer(251, 0.10, 0.50)
traintransfer(251, 0.10, 1)


existsModelTransfer<-function(wd, dataRep, percentData, percentHyp, positive, negative)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.csv.model",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",positive,"_",negative,"ACCGEN_",percentHyp*100,"hyp.csv.model",sep="")) > 0)
  {
    return(1)
  }
    ...
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative)==1)
      {
        for(j in 1:256)
        {
          ...
          if(existsFilePredict(getwd(),dataRep,(percentData+0.2),class,negative2)==1 && existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative2)==1)
          {
            ...
            instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",class,"_",negative2,"ACCGEN_",percentHyp*100,"hyp.csv.model ", sep="")
            instructions3<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative2,"usingACCGEN_",percentHyp*100,"hyp.out ", sep="")
            instructions4<-paste(">> ",getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative2,"usingACCGEN_",percentHyp*100,"hyp.txt", sep="")
            
            instructions<-paste(instructions1, instructions2, instructions3, instructions4,sep="")
            
            write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/testaccgenbalancedunrelated-pos",class,"-",percentData*100,"data-",percentHyp*100,"hyp.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
          }
        }
      }
    }
    ...
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(),dataRep,percentData,percentHyp,class,negative)==1)
      {
        for(j in 1:256)
        {
          ...
          {
            instructions1<-paste(general, getwd(),"/positives/",class,"/",(percentData+0.2)*100,"percent/data/data",dataRep,"/sampletest",class,"_",negative2,".csv.scale ", sep="")        
            instructions2<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/notransfer/data",dataRep,"/sampletransfer",class,"_",negative2,"_",percentHyp*100,"hyp.csv.model ", sep="")
            instructions3<-paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative2,"usingnotransfer_",percentHyp*100,".out ", sep="")
            instructions4<-paste(">> ",getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative2,"usingnotransfer_",percentHyp*100,".txt", sep="")
            
            instructions<-paste(instructions1, instructions2, instructions3, instructions4,sep="")
            
            write.table(instructions, file=paste("C:/Users/dben652/workspace/AccGenSVM/HTL/scripts/testnotransferbalancedunrelated-pos",class,"-",percentData*100,"data.sl",sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
          }
        }
      }
    }
...
predictnotransfer(251, 0.10, 0.10)
predictnotransfer(251, 0.10, 0.25)
predictnotransfer(251, 0.10, 0.50)
predictnotransfer(251, 0.10, 1)

#######

existsFileResultsAccGen<-function(wd, positive, negative, percentData, percentHyp, dataRep)
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",positive,"_",negative,"usingACCGEN_",percentHyp*100,"hyp.txt",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",positive,"_",negative,"usingACCGEN_",percentHyp*100,"hyp.txt",sep="")) > 0)
  {
    return(1)
  }
...
{
  if(file.exists(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",positive,"_",negative,"usingnotransfer_",percentHyp*100,".txt",sep="")) 
     && file.size(paste(wd,"/positives/",positive,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",positive,"_",negative,"usingnotransfer_",percentHyp*100,".txt",sep="")) > 0)
  {
    return(1)
  }
...
resultsaccgen<-function(class, percentData, percentHyp)
{
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative,"usingACCGEN_",percentHyp*100,"hyp.txt",sep=""))
        result<-result$V3
        result<-as.character(strsplit(as.character(result[1]), split="%")[1])
        result<-as.double(result)
        
        result<-paste(dataRep,", ", negative, ", ", result, sep="")
        
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsaccgen_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsaccgenpositive<-function(class, percentData, percentHyp)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsAccGen(getwd(), class, negative, percentData, percentHyp, dataRep) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsaccgenpositive_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsaccgennegative<-function(class, percentData, percentHyp)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsAccGen(getwd(), class, negative, percentData, percentHyp, dataRep) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsaccgennegative_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}
...
resultsnotransfer<-function(class, percentData, percentHyp)
{
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      {
        result<-read.table(paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/test/data",dataRep,"/sampletest",class,"_",negative,"usingnotransfer_",percentHyp*100,".txt",sep=""))
        result<-result$V3
        result<-as.character(strsplit(as.character(result[1]), split="%")[1])
        result<-as.double(result)
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsnotransfer_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsnotransferpositive<-function(class, percentData, percentHyp)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsNoTransfer(getwd(), class, negative, percentData, percentHyp, dataRep) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsnotransferpositive_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}

resultsnotransfernegative<-function(class, percentData, percentHyp)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsFileResultsNoTransfer(getwd(), class, negative, percentData, percentHyp, dataRep) ==1)
      {
        ...
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/resultsnotransfernegative_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}
...
transferrate<-function(class, percentData, percentHyp)
{
  setwd("C:/Users/dben652/workspace/AccGenSVM/data/caltech256/")
  ...
  for(dataRep in 1:30)
  {
    for(i in 1:256)
    {
      ...
      if(existsModelTransfer(getwd(), dataRep, percentData, percentHyp, class, negative) ==1)
      {
        result<-readLines(paste(getwd(),"/positives/",class,"/",percentData*100,"percentbalancedunrelated/transfer/data",dataRep,"/sampletransfer",class,"_",negative,"ACCGEN_",percentHyp*100,"hyp.out",sep=""))
        result<-result[6]
        result<-strsplit(result, split=":")
        resulti<-result[[1]][2]
        resulti<-strsplit(resulti, split=",")[[1]][1]
        resulti<-as.numeric(resulti)
        resultj<-result[[1]][3]
        resultj<-as.numeric(resultj)
        
        result<-paste("i:", resulti, " j:", resultj, sep="")
        
        write.table(result, file=paste(getwd(), "/positives/",class,"/",percentData*100,"percentbalancedunrelated/transferrateaccgen_",percentHyp*100,"hyp.txt", sep=""), append=TRUE, col.names = FALSE, row.names = FALSE, quote = FALSE)
      }
    }
  }
}
