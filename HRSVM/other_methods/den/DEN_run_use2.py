...
#read data
number_tasks = 50
dims = [1000, 500, 250, number_tasks]

for rep in range(1,2):
    os.chdir("C:/Users/Administrator/Desktop/other_methods/den")
    import DEN
    
    os.chdir('C:/Users/Administrator/Desktop/imagenet/sources/data/rep'+str(rep))
    ...
    for i in random.sample(range(len(training_files)), k=number_tasks):  
    ...
    for t in range(FLAGS.n_classes):
        f = open('C:/Users/Administrator/Desktop/imagenet/DEN/den_'+str(number_tasks)+'_tasks_defaultparams_rep'+str(5)+'.txt', 'a')
        sys.stdout = f
